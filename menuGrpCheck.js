...
$(document).ready(function() {
  ...
  var url_d ="/LdmenuGrpController/selectByPrimaryKey.do";
	...
	var col = [{field: 'state',align: 'center',valign : 'middle',checkbox: true,visible: true},
	  			   {field: 'metentid',title: '序号',formatter: function (value, row, index) {  
	   				...
	   				{field: 'menugrpcode',title: '菜单组编码',align: 'center',valign : 'middle',visible: true},
	   				{field: 'menugrpname',title: '菜单组名称',align: 'center',sortable: true,valign : 'middle',visible: true},
	   				{field: 'menugrpdescription',title: '菜单组备注',align: 'center',sortable: true,valign : 'middle'},
	   				{field: 'menustate',title: '菜单状态',align: 'center',valign : 'middle',visible: true,visible: true},
	...
	var sortOrder = "metentid asc";
			...
			$("#serach").click(function() {
				//	   		参数
		   		...
		   		data.menugrpdescription= $("#menugrpdescription").val(),
		   		data.menustate = $("#menustate").val();
...
window.actionEvents = {
		...
		'click .update': function (e, value, row, index) {
			var url = "menuGrpUpdate.jsp?menugrpname=" +row.menugrpname+"&menugrpcode="+row.menugrpcode+"&menugrpdescription="+row.menugrpdescription+"&menustate="+row.menustate;
	        toedit(url);
			...
			if (r==true)
			  {
				$.ajax({
					type : "POST",
					url:path+"/LdmenuGrpController/delete.do",// 后台请求URL地址
					data : "menugrpcode="+row.menugrpcode,
					dataType : "json",
...
function queryParams(params){
    ...
    var param = {
	    	...
	    	//				
	   		...
	   		menugrpdescription:$("#menugrpdescription").val(),
	   		menustate : $("#menustate").val(),
	   		menugrpcode:$("#menugrpcode").val(),
	    }; 
	    return param; 
}
