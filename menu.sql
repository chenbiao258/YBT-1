...
prompt Created on 2017年10月15日 by suojinyu
set feedback off
set define off
...
insert into MENU (id, par_uid, menu_name, menu_desc, menu_status, menu_link, menu_index, t_s_uid, meddle_menu, meddle_menu_name, crt_time, upd_time, sub_menu_name, sub_menu)
values ('5f0ee5b8-15b7a32633c-04fde300662ea89f4870c7447dbb1345', '0', '用户权限查询', '1', '1', '/application/menumang/newMenuMang/jsp/menuGrpSee.jsp', 0, null, 0, '权限管理', to_date('12-01-2017', 'dd-mm-yyyy'), to_date('13-01-2017', 'dd-mm-yyyy'), '系统管理', 3);
insert into MENU (id, par_uid, menu_name, menu_desc, menu_status, menu_link, menu_index, t_s_uid, meddle_menu, meddle_menu_name, crt_time, upd_time, sub_menu_name, sub_menu)
values ('5f0ee5b8-15b7a12633c-04fde300662ea89f4870c7447dbb1345', '0', '权限管理', '2', '1', '/application/menumang/newMenuMang/jsp/menuGrpCheck.jsp', 0, null, 0, '权限管理', to_date('12-01-2017', 'dd-mm-yyyy'), to_date('13-01-2017', 'dd-mm-yyyy'), '系统管理', 3);
insert into MENU (id, par_uid, menu_name, menu_desc, menu_status, menu_link, menu_index, t_s_uid, meddle_menu, meddle_menu_name, crt_time, upd_time, sub_menu_name, sub_menu)
...
insert into MENU (id, par_uid, menu_name, menu_desc, menu_status, menu_link, menu_index, t_s_uid, meddle_menu, meddle_menu_name, crt_time, upd_time, sub_menu_name, sub_menu)
values ('f9ebcd-15ec708286a-068fa46f1dc11d0c2b400336e03d31ce', null, '添加产品 ', '2', null, '/application/laprodquali/newLaprodquali/jsp/laprodqualiAdd.jsp', 0, null, 7, '产品管理模块', to_date('28-01-2017', 'dd-mm-yyyy'), to_date('28-01-2017', 'dd-mm-yyyy'), '人员管理', 2);
insert into MENU (id, par_uid, menu_name, menu_desc, menu_status, menu_link, menu_index, t_s_uid, meddle_menu, meddle_menu_name, crt_time, upd_time, sub_menu_name, sub_menu)
values ('f9ebcd-15ec708d992-068fa46f1dc11d0c2b400336e03d31ce', null, '产品管理', '1', null, '/application/laprodquali/newLaprodquali/jsp/laprodquali.jsp', 0, null, 7, '产品管理模块', to_date('28-01-2017', 'dd-mm-yyyy'), to_date('28-01-2017', 'dd-mm-yyyy'), '人员管理', 2);
insert into MENU (id, par_uid, menu_name, menu_desc, menu_status, menu_link, menu_index, t_s_uid, meddle_menu, meddle_menu_name, crt_time, upd_time, sub_menu_name, sub_menu)
values ('f9ebcd-15ec709f67a-068fa46f1dc11d0c2b400336e03d31ce', '0', '权限新增', '3', '1', '/application/menumang/newMenuMang/jsp/menuGrp.jsp', 0, null, 0, '权限管理', to_date('28-01-2017', 'dd-mm-yyyy'), to_date('28-01-2017', 'dd-mm-yyyy'), '系统管理', 3);
insert into MENU (id, par_uid, menu_name, menu_desc, menu_status, menu_link, menu_index, t_s_uid, meddle_menu, meddle_menu_name, crt_time, upd_time, sub_menu_name, sub_menu)
