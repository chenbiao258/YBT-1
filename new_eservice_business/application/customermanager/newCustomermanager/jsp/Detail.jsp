...
<meta charset="utf-8">
	...
	var salesrole1="<%= request.getParameter("salesrole1")%>"; 
	var salesrole2="<%= request.getParameter("salesrole2")%>"; 
	</script>
</head>
<body class="page-body skin-facebook">
							...
							<form action="" method="" role="form" class="form-horizontal">
								<div class="form-group">
									<div class="col-lg-6 col-md-6 col-xs-6 marginbottom15">
										...
										<div class="col-sm-7">
											 <input type="text" class="form-control" name="staffid" id="staffid" data-validate="required" placeholder="" readonly="readonly" value="<%= request.getParameter("emplID")%>">
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-xs-6 marginbottom15">
										<label class="col-sm-5 control-label" for="field-3">SalesRole1</label>
										<div class="col-sm-7">
											 <input type="text" class="form-control" name="salesrole1" id="salesrole1" data-validate="required" placeholder="" readonly="readonly" value="<%= request.getParameter("salesrole1")%>">
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-xs-6 marginbottom15">
										<label class="col-sm-5 control-label" for="field-3">SalesRole2</label>
										<div class="col-sm-7">
											 <input type="text" class="form-control" name="salesrole2" id="salesrole2" data-validate="required" placeholder="" readonly="readonly" value="<%= request.getParameter("salesrole2")%>">
										</div>
									</div>
								...
								<div>
									<label style="color: red"><h4>注：必须是销售岗位才能销售</h4></label>
									</div>
	...
	<script src="<%=request.getContextPath() %>/application/customermanager/newCustomermanager/res/js/Detail.js" type="text/javascript" charset="utf-8"></script>
