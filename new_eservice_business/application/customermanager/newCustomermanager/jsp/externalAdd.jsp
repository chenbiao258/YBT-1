...
<body class="page-body skin-facebook">
				...
				<div class="col-sm-12">
					<div class="panel panel-default">
						<div class="panel-body">
								...
								<div class="form-group">
									<div class="col-lg-6 col-md-6 col-xs-6 marginbottom15">
										<label class="col-sm-5 control-label" for="licensesCertificationsDescr">Certifications Descr</label>
										<div class="col-sm-7">
									...
									<div class="form-group">
									<div class="col-lg-6 col-md-6 col-xs-6 marginbottom15">
										<label class="col-sm-5 control-label" for="licenseCertificationNo">Certification No</label>
										<div class="col-sm-7">
   ...
   <script src="<%=request.getContextPath() %>/application/customermanager/newCustomermanager/res/js/externalAdd.js" type="text/javascript" charset="utf-8"></script>
