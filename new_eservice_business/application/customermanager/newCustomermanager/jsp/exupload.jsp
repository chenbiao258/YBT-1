...
<div>
<form action="${pageContext.request.contextPath}/externalgiftsController/uploadRM.do" method="post" role="form" class="form-horizontal" enctype="multipart/form-data">
							

        <table style="margin:5px;height:20px;" border=0>
           <tr style="height:20px">
                <td colspan="4" align="left"><font style="font-family:黑体;font-size:30px;color: red">RM外部证书上传：</font></td>
         </tr>
