							...
							<form action="" method="" role="form" class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-lg-6 col-md-6 col-xs-6 marginbottom15">
										...
										<div class="col-sm-2">
											<button type="button" class="btn btn-primary" id="search" >下载GLCS_INFO</button>
										</div>
											</div>
...
$( "#dialog-link, #icons li" ).hover(
	...
	<script src="<%=request.getContextPath() %>/application/customermanager/newCustomermanager/res/js/showdownload.js" type="text/javascript" charset="utf-8"></script>
