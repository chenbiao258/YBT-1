	...
	col = [{field: 'state',align: 'center',valign : 'middle',checkbox: true,visible: true},
                   ...
                   {field: 'staffid',title: 'staffid',align: 'center',sortable: true,valign : 'middle',visible: true},
                    {field: 'name',title: 'name',align: 'center',sortable: true,valign : 'middle'},
	   				...
	   				{field: 'getenddate',title: 'startdate',align: 'center',sortable: true,valign : 'middle'},
...
//	window.showModalDialog("showdialog.jsp",window,"dialogWidth=500px;dialogHeight=150px"); 
	
	
$.ajax({
		type : "POST",
		url:path+"/LatrainingController/downloadall.do",// 后台请求URL地址
		dataType : "json",
		success : function(data) {
			var docpath='aptitudeAll';
			var modifiedname=data+'.xls';
			var url ="download.jsp?path=D:/"+docpath+"/"+modifiedname+"&a="+'sdf';
			toback(url);
...
function queryParams(params){
    ...
    var param = {
	        ...
	        staffid : $("#cc option:selected").val()
