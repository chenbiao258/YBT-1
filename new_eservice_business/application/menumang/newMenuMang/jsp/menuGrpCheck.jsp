...
<body class="page-body  skin-facebook">
								...
								<form id="form-plus" action="" method="" role="form" class="form-horizontal">
									...
									<div class="form-group">
										<div class="col-lg-6 col-md-6 col-xs-6 marginbottom15">
											...
											<div class="col-sm-6">
												<input type="text" class="form-control" name="menugrpname" id="menugrpname" data-validate="required" placeholder="">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-xs-6 marginbottom15">
		...
		<script src="<%=request.getContextPath() %>/application/menumang/newMenuMang/res/js/menuGrpCheck.js" type="text/javascript" charset="utf-8"></script>
