...
<meta charset="utf-8">
	...
	<%
	 String menugrpdescription=new String(request.getParameter("menugrpdescription").getBytes("ISO-8859-1"),"utf-8");
	 
	 String menugrpname=new String(request.getParameter("menugrpname").getBytes("ISO-8859-1"),"utf-8");
	
	%>
		var path = "<%=request.getContextPath() %>";
		var menugrpname = "<%=menugrpname%>";
		var menugrpcode = "<%= request.getParameter("menugrpcode")%>"; 
		var menustate = "<%= request.getParameter("menustate")%>"; 
		var menugrpdescription="<%=menugrpdescription%>";
			
		$(document).ready(function() {
	
		$("#menustate").val(menustate);
		$("#menugrpcode").val(menugrpcode);
...
<body class="page-body  skin-facebook">
								...
								<form>
									...
									<div class="form-group">
										<div class="col-lg-6 col-md-6 col-xs-6 marginbottom15">
											...
											<div class="col-sm-6">
												<input type="text" class="form-control" name="menugrpname" id="menugrpname" value="<%=menugrpname%>">
											</div>
										</div>
										</div>
										<div class="form-group">
										<div class="col-lg-6 col-md-6 col-xs-6 marginbottom15">
											...
											<div class="col-sm-6">
												<input type="text" class="form-control" name="menugrpdescription" id="menugrpdescription" data-validate="required" value="<%= menugrpdescription%>">
											</div>
										</div>
										</div>
										<div class="form-group">
									...
									<input type="hidden" class="form-control" name="menugrpcode" id="menugrpcode" data-validate="required" >
										...
										<div class="col-lg-12 col-md-12 col-xs-12 marginbottom15" style="margin-top: 5%">
											...
											<div class="col-sm-1">
												<button type="submit" class="btn btn-primary serach">修改</button>
											</div>
											<div class="col-sm-1">
		...
		<script src="<%=request.getContextPath() %>/application/menumang/newMenuMang/res/js/menuGrpUpdate.js" type="text/javascript" charset="utf-8"></script>
