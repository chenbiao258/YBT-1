...
$(document).ready(function() {
	...
	var init_url = "/menuController/queryByGrpMenuall.do";
	
  var url_d ="/menuController/queryByGrpMenuall.do";
...
$(function(){
	...
	function mycheckbox(seq){
		 ...
		 for(var i=0;i<arr.length;i++){
			 insertLDUserTOMenuGrpA(arr[i].submenu,arr[i].meddlemenu,arr[i].menuDesc,seq,i,arr.length);
		 }
