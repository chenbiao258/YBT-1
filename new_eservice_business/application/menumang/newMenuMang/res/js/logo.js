...
$(document).ready(function() {
  ...
  var url_d ="/tracertController/select.do";
	...
	var col = [{field: 'state',align: 'center',valign : 'middle',checkbox: true,visible: true},
	  			   {field: 'metentid',title: '序号',formatter: function (value, row, index) {  
	   				...
	   				{field: 'username',title: '用户编码',align: 'center',valign : 'middle',visible: true},
	   				{field: 'matter',title: '操作内容',align: 'center',sortable: true,valign : 'middle',visible: true},
	   				{field: 'states',title: '状态',align: 'center',sortable: true,valign : 'middle',visible: true},
	   				{field: 'jspname',title: '操作界面',align: 'center',sortable: true,valign : 'middle',visible: true},
	   				{field: 'opdates',title: '操作日期',align: 'center',sortable: true,valign : 'middle',visible: true},
	   				{field: 'optime',title: '操作时间',align: 'center',sortable: true,valign : 'middle',visible: true},
			...
			$("#serach").click(function() {
				//	   		参数
		   		...
		   		if(data.username!=""){
					...
					document.getElementById("la").innerHTML="请输入用户名称";
		   		}
