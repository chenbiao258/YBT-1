...
var url_d = "/UserSearchController/selectAll.do";
...
function actionFormatter(value, row, index) {      
	return [
        '<button class="btn btn-red check">审核</button>'
	].join('');
}
...
window.actionEvents = {
	...
	'click .check' : function(e, value, row, index) {
		var url = "userCheck.jsp?emplID=" + row.emplID+"&checkFlag="+row.checkFlag+"&status="+row.status;
        toedit(url);
	},
	//删除
