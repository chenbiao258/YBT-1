...
<meta charset="utf-8">
	...
	<body class="page-body skin-facebook">
		...
		<script src="<%=request.getContextPath() %>/application/newTestingCenter/newCaseManage/res/js/addCase.js" type="text/javascript" charset="utf-8"></script>
