...
<meta charset="utf-8">
	...
	<body class="page-body skin-facebook">
								...
								<form action="" method="" role="form" class="form-horizontal">
									...
									<div class="form-group">
										<div class="col-lg-6 col-md-6 col-xs-6 marginbottom15">
											<label class="col-sm-4 control-label" for="field-3"><span class="red">*</span>保单印刷号</label>
											<div class="col-sm-6">
												<input type="text" class="form-control" name="contPrintNo" id="contPrintNo" data-validate="required" placeholder="">
											</div>
										</div>
		...
		<script src="<%=request.getContextPath() %>/application/newTestingCenter/rePrintCont/res/js/testTrans.js" type="text/javascript" charset="utf-8"></script>
