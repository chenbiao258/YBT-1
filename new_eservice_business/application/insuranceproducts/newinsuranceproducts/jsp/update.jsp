...
<body class="page-body skin-facebook">
							...
							<form action="" method="" role="form" class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-lg-6 col-md-6 col-xs-6 marginbottom15">
										...
										<div class="col-sm-7">
											<select class="form-control" id="riskType" name="riskType" onchange="query()">
												<option></option>
    ...
    <script src="<%=request.getContextPath() %>/application/insuranceproducts/newinsuranceproducts/res/js/update.js" type="text/javascript" charset="utf-8"></script>
</body>
</html>