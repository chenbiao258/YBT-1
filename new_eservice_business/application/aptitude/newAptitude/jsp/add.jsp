...
<body class="page-body skin-facebook">
						...
						<div class="panel-body">
							<form id="form-plus">
									...
									<div class="col-lg-6 col-md-6 col-xs-6 marginbottom15">
										<label class="col-sm-5 control-label" for="field-3">类型</label>
										<div class="col-sm-7">
										<select name="codealias" id="codealias">
										  <option></option>
									...
									<div class="col-lg-6 col-md-6 col-xs-6 marginbottom15">
										<label class="col-sm-5 control-label" for="field-3">编号</label>
										<div class="col-sm-7">
											<input type="text" class="form-control" name="code" id="code" data-validate="required" placeholder="" >
										</div>
									</div>
									</div>
									<div class="form-group">
									<div class="col-lg-6 col-md-6 col-xs-6 marginbottom15">
										<label class="col-sm-5 control-label" for="field-3">资质名</label>
										<div class="col-sm-7">
											<input type="text" class="form-control" name="codename" id="codename" data-validate="required" placeholder="">
										</div>
								   </div>
								   <input type="hidden" class="form-control" name="codetype" id="codetype" data-validate="required" placeholder="" readonly="readonly" value="natural">
	...
	<script src="<%=request.getContextPath() %>/include/js/bootstrapValidator.min.js"></script>
	   <script src="<%=request.getContextPath() %>/application/aptitude/newAptitude/res/js/add.js" type="text/javascript" charset="utf-8"></script>
