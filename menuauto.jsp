...
<body class="page-body  skin-facebook">
								...
								<form id="form-plus" action="" method="" role="form" class="form-horizontal">
									...
									<div class="form-group">
										<div class="col-lg-6 col-md-6 col-xs-6 marginbottom15">
											<label class="col-sm-4 control-label" for="field-3"><span class="red">*</span>用户名称</label>
											<div class="col-sm-6">
		...
		<script src="<%=request.getContextPath() %>/application/menumang/newMenuMang/res/js/menuauto.js" type="text/javascript" charset="utf-8"></script>
